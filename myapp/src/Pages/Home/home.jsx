...
const Home = () => {
  return (
    <div className="mt-[80px]">
      ...
      <button className="bg-blue-400 p-4 rounded-xl text-white font-medium ml-[600px]"><Link to='/house'>Order</Link></button>
    ...
    <h1 className="text-center font-semibold text-5xl pt-[20px]">Our Sponsor:</h1>
